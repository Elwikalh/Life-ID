...
const items: Item[] = [
  ...
  { label: "المرضى", icon: Users, href: "/admin/patients" },
  { label: "الأطباء", icon: Stethoscope, href: "/admin/doctors" },
  { label: "المستشفيات", icon: Building, href: "/admin/hospitals" },
  { label: "العيادات", icon: Building2, href: "/admin/clinics" },
  { label: "الصيدليات", icon: Pill, href: "/admin/pharmacies" },
  { label: "المعامل", icon: FlaskConical, href: "/admin/laboratories" },
  { label: "مراكز الأشعة", icon: Scan, href: "/admin/radiologies" },
  { label: "شركات الأدوية", icon: Factory, href: "/admin/pharma-companies" },
